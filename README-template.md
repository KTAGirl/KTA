...
| OPTIONAL Mods / Plugins <br> (disabled in KTA-Lite profile) | %OPTIONALMODS%/%OPTIONALESXS% (it is only eye and ear candy, increasing GPU requirements and DL times a lot )|
| Largest Mod | DD, 2.9G | 
