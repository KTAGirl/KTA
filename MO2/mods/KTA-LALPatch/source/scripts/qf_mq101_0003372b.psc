...
Alias_KeepLever1.GetReference().Activate(Alias_BarracksRoomSoldier02.GetRef())
...
Alias_TrophyRoomPrisoner01.GetActorReference().StartCombat(Game.GetPlayer())
Alias_TrophyRoomPrisoner02.GetActorReference().StartCombat(Game.GetPlayer())
;END CODE
EndFunction
;END FRAGMENT
...
Alias_BarracksRoomSoldier01.GetActorReference().StartCombat(Game.GetPlayer())
Alias_BarracksRoomSoldier02.GetActorReference().StartCombat(Game.GetPlayer())
...
Alias_HelgenArcher01.TryToDisableNoWait()
Alias_HelgenArcher02.TryToDisableNoWait()
;Alias_HelgenArcher03.TryToDisableNoWait()
;Alias_HelgenArcher04.TryToDisableNoWait()
...
;Disable 3 actors who sometimes show up alive when they shouldn't.
...
; remove all player's gear and reequip outfit (commented out by Arthmoor - already done in my quest)
;Game.GetPlayer().RemoveAllItems()
; equip player's prisoner outfit
...
;BEGIN CODE
; cart 1 stops
Alias_Cart1.GetReference().SetMotionType(Alias_Cart1.GetRef().Motion_Keyframed)
